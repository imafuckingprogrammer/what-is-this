          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredPortfolio.map((project) => (
              <div key={project.id} className="group">
                <div className="aspect-[4/3] mb-6 hover:opacity-90 transition-opacity rounded-2xl overflow-hidden">
                  <img 
                    src={`https://picsum.photos/400/300?random=${project.id + 20}`}
                    alt={project.title}
            ...
            {caseStudies.map((study, index) => (
              <div key={index} className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                <div className="order-1 lg:order-2">
                  <div className="aspect-[4/3] lg:sticky lg:top-32 rounded-2xl overflow-hidden">
                    <img 
                      src={`https://picsum.photos/600/450?random=${index + 50}`}
                      alt={study.title}
                      className="w-full h-full object-cover"
                    />
                  </div>
