        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="aspect-[4/3] lg:aspect-[3/4] rounded-2xl overflow-hidden">
              <img 
                src="https://picsum.photos/500/600?random=60"
                alt="TrendArt team working"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {team.map((member, index) => (
              <div key={index} className="text-center">
                <div className="aspect-square mb-6 hover:opacity-90 transition-opacity rounded-2xl overflow-hidden">
                  <img 
                    src={`https://picsum.photos/300/300?random=${index + 70}`}
                    alt={member.name}
                    className="w-full h-full object-cover"
                  />
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="aspect-[4/3] rounded-2xl overflow-hidden">
              <img 
                src="https://picsum.photos/600/450?random=80"
      ...
      <section className="py-32 px-6 lg:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="aspect-[4/3] rounded-2xl overflow-hidden">
              <img 
                src="https://picsum.photos/600/450?random=90"
                alt="TrendArt office culture"
                className="w-full h-full object-cover"
              />
            </div>
            <div>
