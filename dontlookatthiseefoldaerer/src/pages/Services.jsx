    ...
    <div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <AnimatedSection direction="up" delay={0.2}>
            <h1 className="text-5xl md:text-6xl font-bold text-black mb-8">
              <TextReveal text="Services that drive real business results" />
            </h1>
          </AnimatedSection>
      ...
      <section className="py-32 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <AnimatedSection className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-black mb-6">
              <TextReveal text="Pricing packages" />
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            {pricingTiers.map((tier, index) => (
              ...
              >
                <motion.div
                  ...
                  className={`bg-white p-8 shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl ${
        ...
        <div className="max-w-4xl mx-auto text-center">
          <AnimatedSection direction="up">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              <TextReveal text="Ready to get started?" className="text-white" />
            </h2>
          </AnimatedSection>
          <AnimatedSection direction="up" delay={0.2}>
