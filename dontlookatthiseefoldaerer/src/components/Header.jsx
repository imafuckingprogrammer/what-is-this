      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex items-center relative">
            ...
            <div className="absolute inset-0 bg-white/20 backdrop-blur-xl rounded-full px-6 py-3 border border-white/20" 
                 style={{
              ...
              {navigation.map((item) => (
                ...
                >
                  <motion.div
                    className="relative"
                    animate={{
                      color: location.pathname === item.href ? "#000000" : "#6b7280"
                    }}
                    whileHover={{
                      color: "#000000",
                      transition: { 
