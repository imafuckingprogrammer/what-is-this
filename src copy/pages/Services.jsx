    ...
    <div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="space-y-8">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-black mb-6">What's included:</h3>
                ...
                <div className="bg-gray-50 p-6 rounded-2xl">
                  <h4 className="font-semibold text-black mb-3">Case study:</h4>
      ...
      <section className="py-32 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <AnimatedSection className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-black mb-6">
              <SmoothTextReveal text="Pricing packages" />
            </h2>
            <SmoothTextReveal 
              text="Transparent pricing for every stage of business growth. All packages can be customized to meet your specific needs and objectives."
              className="text-xl text-gray-600 max-w-3xl mx-auto"
              delay={0.1}
            />
          </AnimatedSection>
            ...
            {pricingTiers.map((tier, index) => (
              ...
              >
                <motion.div
                  ...
                  className={`bg-white p-8 border border-gray-200 hover:border-gray-300 transition-all duration-300 rounded-2xl ${
                    tier.popular ? 'border-black border-2' : ''
                  }`}
                >
                {tier.popular && (
                ...
                <div className="space-y-3 mb-8">
                  {tier.features.map((feature, featureIndex) => (
                    <div key={featureIndex} className="text-gray-600 font-medium">
                      {feature}
                    </div>
                  ))}
                </div>
                ...
                <Link to="/contact">
                  <CleanButton 
                    text={tier.name === 'Enterprise' ? 'Contact' : 'Choose'}
                    className="w-full"
                  />
                </Link>
                </motion.div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <AnimatedSection direction="up">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-black">
              <SmoothTextReveal text="Ready to get started?" className="text-black" />
            </h2>
          </AnimatedSection>
          <AnimatedSection direction="up" delay={0.2}>
            <SmoothTextReveal 
